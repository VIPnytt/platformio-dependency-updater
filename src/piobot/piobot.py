...
class Piobot:
    ...
    def _bump(self, dependency: models.Dependency, result: models.Result) -> None:
        ...
        pr = repo.create_pull(
            base=self.ref,
            body=f"{result.body}\n\n---\n<sub>Close this PR to ignore this release. [platformio-dependency-updater](https://github.com/VIPnytt/platformio-dependency-updater) will retain this choice and suggest the next eligible release.</sub>",
            head=head,
